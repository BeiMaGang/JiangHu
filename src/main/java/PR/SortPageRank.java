...
public class SortPageRank {
    ...
    public static void main(String[] args)
        ...
        job.setMapperClass(SortPageRank.SortMap.class);
        job.setReducerClass(SortPageRank.SortReduce.class);
        job.setSortComparatorClass(SortPageRank.SortComparator.class);
